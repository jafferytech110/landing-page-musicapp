...
const MusicPlayer = () => {
  return (
    <div className="musicPlayer flex flex-col px-5 w-[100%] border-2 border-none py-3 rounded-xl mt-5 musicPlayerStyle">
        <div className="upperPart flex items-center justify-between">
            <div className="profile flex">
                <img src={require('../img/Mask Group 23.png')} alt="profile" className='w-[2.5rem] h-[2.5rem] border-2 border-white rounded-full'/>
                <div className="details flex flex-col ml-4">
                    <span className='text-[1rem]'>Somebody wants you</span>
                    <span className='text-sm text-gray-500'>Enriqure Iglesias</span>
                </div>
            </div>
            <div>
                <img src={require('../img/path.png')} alt="menu" className='h-[1rem]'/>
            </div>
        </div>
        <div className="lowerPart">
            <div className="track flex justify-between text-sm flex-[2] mt-4">
                <span>2: 30</span>
                <img src={require('../img/Group 9.png')} alt="music" className='w-[16rem]'/>
                <span>3: 30</span>
            </div>
            <div className="controls flex-1 flex items-center justify-around mt-4">
          {/* previous arrow */}
